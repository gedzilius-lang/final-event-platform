...
export default function NewVenuePage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      name: form.get('name'), slug: form.get('slug'), city: form.get('city'),
      address: form.get('address'), capacity: Number(form.get('capacity')),
    ...
    try {
      ...
      router.push('/admin/catalog/venues'); router.refresh()
